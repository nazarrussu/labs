...
//надає можливість стерати за собою минулі повідомлення;
...
//провірка наявність змінних name;
    if (!name) {
        name = input;
        clearOutput();
        printMessage(`${name}, загадано число від 0 до 50. Попробуй відгадати його за найменшу кількість спроб. Після кажної спроби я скажу "мало", "багато" чи "вірно".`);
        return;
    }
